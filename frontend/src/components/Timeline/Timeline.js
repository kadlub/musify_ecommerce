            ...
            <ol className="items-center sm:flex">
                <li className="relative mb-6 sm:mb-0">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-sm font-semibold text-gray-900">Zamówienie złożone</h3>
                    </div>
                </li>
                <li className="relative mb-6 sm:mb-0">
                    <div className="flex items-center">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-sm font-semibold text-gray-900">W trakcie realizacji</h3>
                    </div>
                </li>
                <li className="relative mb-6 sm:mb-0">
                    <div className="flex items-center">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-sm font-semibold text-gray-900">W trakcie dostawy</h3>
                    </div>
                </li>
                <li className="relative mb-6 sm:mb-0">
                    <div className="flex items-center">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-sm font-semibold text-gray-900">Dostarczone</h3>
                    </div>
                </li>
            </ol>
        </div>
